...
const Gallery = () => {
  ...
  // Added "Portfolio" to tabs
  const tabs = ["All", "Photos", "Videos", "Portfolio"];
  ...
  const filteredItems = items.filter((item) => {
    if (activeTab === "All" || activeTab === "Portfolio") return true; 
  ...
  return (
    <div className="min-h-screen bg-gray-50 pt-32 pb-24 font-sans">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {activeTab === "Portfolio" ? (
          <motion.div 
            ...
            className="w-full bg-white rounded-3xl shadow-xl border border-gray-200 overflow-hidden flex flex-col h-[70vh] md:h-[80vh]"
          >
            {/* PDF Toolbar */}
            <div className="bg-gray-50 border-b border-gray-200 p-4 md:px-8 flex justify-between items-center z-10 relative shadow-sm">
              <div>
                <h2 className="font-black text-gray-900 md:text-lg">Company Portfolio</h2>
                <p className="text-xs text-gray-500 font-medium mt-0.5">Interactive Document</p>
              </div>
              <a 
                // CHANGE 'fallbackPdfUrl' to your imported 'companyPortfolioPdf' variable
                href={fallbackPdfUrl} 
                target="_blank" 
                rel="noopener noreferrer"
                className="flex items-center gap-2 bg-red-600 hover:bg-red-700 text-white px-5 py-2.5 rounded-xl text-sm font-bold transition-all shadow-md hover:shadow-red-600/30 active:scale-95"
              >
            ...
            {/* Embedded PDF Viewer */}
            <div className="w-full flex-grow bg-gray-100/50">
              <iframe 
                // CHANGE 'fallbackPdfUrl' to your imported 'companyPortfolioPdf' variable
                src={`${fallbackPdfUrl}#view=FitH`} 
        ...
        /* ========================================================================= */
        /* VIEW 2: PHOTO / VIDEO GRID (Existing Code)                                */
        /* ========================================================================= */
          <>
            <motion.div 
              layout
      ...
      {/* ========================================================================= */}
      <AnimatePresence>
        {selectedIndex !== null && activeTab !== "Portfolio" && (
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
