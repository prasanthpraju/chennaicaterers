...
export default function MorningPage() {
  ...
  useEffect(() => {
    // Updated API endpoint for breakfast
    // Note: Ensuring the URL encoding is correct for "Break fast"
  ...
  if (error) {
    return (
      <div className="p-10 text-center flex flex-col items-center justify-center min-h-[50vh]">
        ...
        <p className="text-gray-500 mb-6">We couldn't load the breakfast items right now.</p>
        <button
    ...
    <div className="p-6 max-w-7xl mx-auto min-h-screen bg-gray-50/50">
      ...
      <header className="mb-10 text-center md:text-left">
        ...
        <p className="text-gray-500 text-lg">
          A delicious and healthy meal to start your day right.
        </p>
      </header>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
        {data.length > 0 ? (
              ...
              >
                ...
                <div className="p-5 flex flex-col flex-grow">
                  ...
                  <p className="text-gray-500 text-sm flex-grow mb-5 line-clamp-2">
                    {item.description || "A delicious meal to start your day."}
                  </p>
          ...
          <div className="col-span-full py-20 flex flex-col items-center justify-center text-center bg-white rounded-2xl border border-gray-200 border-dashed">
            ...
            <p className="text-gray-600 text-lg font-medium">No breakfast items available right now.</p>
